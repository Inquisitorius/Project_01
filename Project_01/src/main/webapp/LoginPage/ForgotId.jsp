...
<main class="container">
	...
	<div class="row" style="justify-content:center; height:40px; margin-top:20px; margin-bottom:20px">
		<div class="col-md-3" style="display:flex; justify-content: space-around; padding:0px;">
			...
			<button type="button" class="choose_Style" onclick="chooseMethod(this.id)" id="phoneCheck" style="color:green; width:100%; height:100%;"  disabled>휴대폰 번호</button>
			</div>
			<div class="col-md-6" style="padding-right:10px;">
			<button type="button" class="choose_Style" onclick="chooseMethod(this.id)" id="emailCheck" style="width:100%; height:100%;">이메일 주소</button>
			</div>
		</div>
		</div>	
