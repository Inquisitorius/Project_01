...
<footer class = "flex-nowrap" style = "padding-top: 30px; width: 100%">
	...
	<div class = "container" style = "margin-bottom: 20px; max-width: 1050px; padding-left: 0px;">
		<div class = "row d-felx flex-nowrap" style = "display: flex; justify-content: space-between;">
			<div class = "col-5" style = "min-width: 400px;">
				<div class = "row">
					<label class = "fontCommon_Option_conect" style = "padding-bottom: 17px;  font-weight: 500;  font-size: 20px; line-height: 29px;">고객 행복센터</label>
				</div>	
				<div class = "row">		
					<div>
						<label class = fontCommon_Option_conect style = "padding-bottom: 20px; font-weight: 900;  font-size: 28px; line-height: 40px;">1688-1213</label>
						<span class = "fontCommon_Option_conect" style = "margin-left : 10px; line-height: 55px;">월~토요일 오전 7시 - 오후 6시</span>
					</div>
				</div>	
				<div class = "row flex-nowrap">		
					<button type="button" class="btn btn-outline-secondary" style = "width: 138px; margin-left : 15px;">문의하기</button>
					<label class = "fontCommon_Option_conect" style = "font-size: 14px; vertical-align: top; margin-left : 10px;">월~토요일 머시깽이<br/>일/공휴일 머시깽이</label>
					...
					<div class = "col-md-7" style = "padding-left: 0px;">
						<div class = "row"><label class = "fontTest" style = "font-size: 14px; vertical-align: top;">월~토요일 머시깽이</label></div>
						<div class = "row"><label class = "fontTest" style = "font-size: 14px; vertical-align: top;">일/공휴일 머시깽이</label></div>
					</div>-->
				</div>		
			</div>
			<div class = "col-5" style = "display: flex; align-items: flex-end;">
			<label class = "fontCommon_Option_conect" style = "color: #eaeaea; font-size: 12px; white-space: nowrap;">
	...
	<div class = "container" style = "border-top: 1px solid #eaeaea; max-width: 1050px; padding-left: 0px;">
		<div class = "row flex-nowrap" style = "margin-top: 20px; display: felx;">
			<div class = "col">
				<button type = "button" style = "display: inline-flex; white-space: nowrap; align-items: center; background-color: transparent; border: 0;">
					<img src="/resources/img/contect/isms.png" alt="isms 로고" style = "width: 44px; padding-right: 10px;">
					<p class = "fontCommon_Option_conect" style = "text-align: left; font-size: 9px; margin: 0px;">[인증범위] 컬리 쇼핑몰 서비스 개발·운영<br>(심사받지 않은 물리적 인프라 제외)<br>[유효기간] 2022.01.19 ~ 2025.01.18</p>
				</button>
			</div>
			<div class = "col">
				<button type = "button" style = "display: inline-flex; white-space: nowrap; align-items: center; background-color: transparent; border: 0;">
			...
			<div class = "col">
				<button type = "button" style = "display: inline-flex; white-space: nowrap; align-items: center; background-color: transparent; border: 0;">
					<img src="/resources/img/contect/logo_tosspayments.svg" alt="isms 로고" style = "width:112px; padding-right: 10px;">
					<p class = "fontCommon_Option_conect" style = "text-align: left; font-size: 9px; margin: 0px;">[인증범위] 컬리 쇼핑몰 서비스 개발·운영<br>(심사받지 않은 물리적 인프라 제외)<br>[유효기간] 2022.01.19 ~ 2025.01.18</p>
				</button>
			</div>
			<div class = "col">
	...
	<div class = "container-fluid" style = "padding-left: 0px; margin: 0px;">
		<div class = "row">
			<div class = "col-12" style = "background: black; margin-top: 20px; display: inline-flex; justify-content: center;">
				<label class = "fontCommon_Option_conect" style = "font-size: 10px; white-space: nowrap; text-align: center; width: 1200px; margin-top: 10px; margin-bottom: 10px;">
