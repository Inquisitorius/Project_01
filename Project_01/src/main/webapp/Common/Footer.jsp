	...
	<div class = "container" style = "margin-bottom: 20px; max-width: 1050px; padding-left: 0px;">
		<div class = "row d-felx flex-nowrap" style = "display: flex; justify-content: space-between;">
			<div class = "col-5" style = "min-width: 400px;">
				...
				<div class = "row">		
					<div>
						<label class = "fontCommon_Option" style = "padding-bottom: 20px; font-weight: 900;  font-size: 28px; line-height: 40px;">1688-1213</label>
						<span class = "fontCommon_Option" style = "margin-left : 10px; line-height: 55px;">월~토요일 오전 7시 - 오후 6시</span>
					</div>
				</div>	
