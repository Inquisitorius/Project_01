		...
		<div class = "row flex-nowrap" style = "display: flex; justify-content: space-between;">
			<div class = "col-md-5" style = "min-width: 400px;">
				...
				<div class = "row flex-nowrap">		
					...
					<label class = "fontTest" style = "font-size: 14px; vertical-align: top; margin-left : 10px;">월~토요일 머시깽이<br/>일/공휴일 머시깽이</label>
			...
			<label class = "fontTest" style = "color: #333333; font-size: 12px; white-space: nowrap;">
	...
	<div class = "container-fluid">
		<div class = "row">
			<div class = "col-md-12" style = "background: rgb(247, 247, 247); margin-top: 20px;">
				<label class = "fontTest" style = "font-size: 10px; white-space: nowrap; text-align: center; width: 100%; margin-top: 10px; margin-bottom: 10px;">
